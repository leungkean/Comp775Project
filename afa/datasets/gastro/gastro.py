...
url="https://drive.google.com/file/d/1QCoH8vgzXTCqhYe1swqPtzDXlYr-Geow/view?usp=share_link"

class Gastro(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        data_path = gdown.download(
            url=url, output=os.path.join(dl_manager.download_dir, "gastro_data.pkl"), fuzzy=True 
        )
